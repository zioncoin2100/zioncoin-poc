...
//
//  Zioncoin-SCP.x
//  Zioncoin-ledger-entries.x
//  Zioncoin-ledger.x
//  Zioncoin-overlay.x
//  Zioncoin-transaction.x
//  Zioncoin-types.x
//
...
import (
	...
	"github.com/zioncoin/go-xdr/xdr3"
)
...
// ZioncoinValueExt is an XDR NestedUnion defines as:
//
//   union switch (int v)
//        {
//        case 0:
...
//        }
//
type ZioncoinValueExt struct {
	V int32
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u ZioncoinValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of ZioncoinValueExt
func (u ZioncoinValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch int32(sw) {
	case 0:
		return "", true
	}
...
// NewZioncoinValueExt creates a new  ZioncoinValueExt.
func NewZioncoinValueExt(v int32, value interface{}) (result ZioncoinValueExt, err error) {
	result.V = v
	switch int32(v) {
	case 0:
		// void
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s ZioncoinValueExt) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *ZioncoinValueExt) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*ZioncoinValueExt)(nil)
	_ encoding.BinaryUnmarshaler = (*ZioncoinValueExt)(nil)
)

// ZioncoinValue is an XDR Struct defines as:
//
//   struct ZioncoinValue
//    {
...
//    };
//
type ZioncoinValue struct {
	TxSetHash Hash
	CloseTime Uint64
	Upgrades  []UpgradeType `xdrmaxsize:"6"`
	Ext       ZioncoinValueExt
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s ZioncoinValue) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *ZioncoinValue) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*ZioncoinValue)(nil)
	_ encoding.BinaryUnmarshaler = (*ZioncoinValue)(nil)
)
...
//        ZioncoinValue scpValue;   // what consensus agreed to
...
// ZioncoinMessage is an XDR Union defines as:
//
//   union ZioncoinMessage switch (MessageType type)
//    {
//    case ERROR_MSG:
//        Error error;
//    case HELLO:
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u ZioncoinMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of ZioncoinMessage
func (u ZioncoinMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewZioncoinMessage creates a new  ZioncoinMessage.
func NewZioncoinMessage(aType MessageType, value interface{}) (result ZioncoinMessage, err error) {
	result.Type = aType
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u ZioncoinMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u ZioncoinMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s ZioncoinMessage) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *ZioncoinMessage) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*ZioncoinMessage)(nil)
	_ encoding.BinaryUnmarshaler = (*ZioncoinMessage)(nil)
)
...
//    {
//       uint64 sequence;
//       ZioncoinMessage message;
//       HmacSha256Mac mac;
//        }
//
type AuthenticatedMessageV0 struct {
	Sequence Uint64
	Message  ZioncoinMessage
	Mac      HmacSha256Mac
}
