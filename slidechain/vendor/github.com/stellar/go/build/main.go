...
// structures used by the zioncoin network, most importanly transactions.
//
...
var (
	...
	// to the main public zioncoin network.
	...
	// to the test zioncoin network (often called testnet).
	TestNetwork = Network{network.TestNetworkPassphrase}

	// DefaultNetwork is a mutator that configures the
	// transaction for submission to the default zioncoin
...
// Network establishes the zioncoin network that a transaction should apply to.
