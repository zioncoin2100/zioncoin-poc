...
import (
	...
	"github.com/zioncoin/go/protocols/equator/base"
	"github.com/zioncoin/go/strkey"
	"github.com/zioncoin/go/support/errors"
	"github.com/zioncoin/go/support/render/hal"
...
type Root struct {
	...
	HorizonVersion       string `json:"equator_version"`
	ZioncoinCoreVersion   string `json:"core_version"`
...
// Trade represents a equator digested trade
type Trade struct {
	Links struct {
		Self      hal.Link `json:"self"`
