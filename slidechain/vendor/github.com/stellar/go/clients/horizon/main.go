// Package equator provides client access to a equator server, allowing an
...
// HTTP represents the HTTP client that a equator client uses to communicate
type HTTP interface {
...
// ensure that the equator client can be used as a SequenceProvider
var _ build.SequenceProvider = &Client{}

// ensure that the equator client implements ClientInterface
