...
// Root loads the root endpoint of equator
...
// LoadAccount loads the account state from equator. err can be either error
// object or equator.Error object.
...
// LoadAccountOffers loads the account offers from equator. err can be either
// error object or equator.Error object.
...
// LoadTradeAggregations loads the trade aggregation from equator.
...
// LoadTrades loads the /trades endpoint from equator.
...
// SubmitTransaction submits a transaction to the network. err can be either error object or equator.Error object.
