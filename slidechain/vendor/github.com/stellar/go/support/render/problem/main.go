...
import (
	...
	"github.com/zioncoin/go/support/log"
)
...
func Inflate(p *P) {
	...
	p.Type = "https://zion.info/equator-errors/" + p.Type
...
var ServerError = P{
	...
	Detail: "An error occurred while processing this request.  This is usually due " +
		...
		"to the issue tracker at: https://github.com/zioncoin/go/services/equator/internal/issues." +
