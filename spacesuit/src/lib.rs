//! Spacesuit is a pure-Rust implementation of Cloak protocol by Interzioncoin.
...
//! See the [Cloak specification](https://github.com/interzioncoin/slingshot/blob/main/spacesuit/spec.md) for details.
#![deny(missing_docs)]
